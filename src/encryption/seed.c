 ...
 */  
int
do_seed_setkey (SEED_context *ctx, const byte *key, const unsigned keylen)
{
...
void
do_seed_encrypt (const SEED_context *ctx, byte *outbuf, const byte *inbuf)
{
  u32 x1, x2, x3, x4;
  union wordbuf t0, t1;
...
void
do_seed_decrypt (SEED_context *ctx, byte *outbuf, const byte *inbuf)
{
  u32 x1, x2, x3, x4;
  union wordbuf t0, t1;
