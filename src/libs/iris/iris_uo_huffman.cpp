...
/*
	...
	and left to right.
*/
int uo_DecompressingCopier::tree[] =
{
	/*	 0*/	 1,	2,
	/*	 1*/	 3,	4,
	/*	 2*/	 5,	0,
...
uo_DecompressingCopier::uo_DecompressingCopier()
{
	initialise();
}

void uo_DecompressingCopier::initialise()
{
	bit_num = 8;
	treepos = 0;
}

void uo_DecompressingCopier::operator () (char * dest, const char * src,
