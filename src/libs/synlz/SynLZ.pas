...
// fpc SynLZ.pas -Sg -Xs -Os -WN

// https://raw.githubusercontent.com/synopse/mORMot/master/SynLZ.pas
library SynLZ;
{$mode objfpc}{$H+}
uses
  Classes, windows;
...
function SynLZcompressdestlen(in_len: integer): integer; stdcall;
...
function SynLZdecompressdestlen(in_p: PAnsiChar): integer; stdcall;
...
{$ifndef PUREPASCAL}
function SynLZcompress1asm(src: PAnsiChar; size: integer; dst: PAnsiChar): integer; stdcall;
asm
        push    ebp
        push    ebx
        push    esi
...
function SynLZcompress1pas(src: PAnsiChar; size: integer; dst: PAnsiChar): integer; stdcall;
...
function SynLZdecompress1b(src: PAnsiChar; size: integer; dst: PAnsiChar): Integer; stdcall;
...
{$ifndef PUREPASCAL}
function SynLZdecompress1asm(src: PAnsiChar; size: integer; dst: PAnsiChar): Integer; stdcall;
asm
        push    ebp
        push    ebx
        push    esi
...
function SynLZdecompress1pas(src: PAnsiChar; size: integer; dst: PAnsiChar): Integer; stdcall;
var last_hashed: PAnsiChar; // initial src and dst value
    src_end: PAnsiChar;
    CWbit: integer;
    CW, v, t, h: integer;
...
function SynLZdecompress1partial(src: PAnsiChar; size: integer; dst: PAnsiChar; maxDst: Integer): Integer; stdcall;
var last_hashed: PAnsiChar; // initial src and dst value
...
function SynLZcompress2(src: PAnsiChar; size: integer; dst: PAnsiChar): integer; stdcall;
var dst_beg,      // initial dst value
    src_end,      // real last byte available in src
    src_endmatch, // last byte to try for hashing
    o: pAnsiChar;
...
function SynLZdecompress2(src: PAnsiChar; size: integer; dst: PAnsiChar): Integer; stdcall;
...
function Hash32(P: PIntegerArray; L: integer): cardinal; stdcall;
