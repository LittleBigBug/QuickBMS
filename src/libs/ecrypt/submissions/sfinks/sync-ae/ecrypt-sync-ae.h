 ...
 */
#define ECRYPT_NAME "SFINKS"    /* [edit] */ 
...
#define ECRYPT_MAXKEYSIZE 80                  /* [edit] (Only 80 bit key is supported)*/
#define ECRYPT_KEYSIZE(i) (80 + (i)*1)        /* [edit] */

#define ECRYPT_MAXIVSIZE 80                   /* [edit] (Only 80 bit iv is supported)*/
#define ECRYPT_IVSIZE(i) (80 + (i)*1)         /* [edit] */

#define ECRYPT_MAXMACSIZE 64                  /* [edit] (Only 64 bit mac is supported)*/
#define ECRYPT_MACSIZE(i) (64 + (i)*1)        /* [edit] */
