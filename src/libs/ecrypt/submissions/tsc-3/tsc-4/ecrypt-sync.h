...
#define ECRYPT_MAXKEYSIZE 80   /* constant keysize 80 bit */
#define ECRYPT_KEYSIZE(i) (80 + (i)*8) 

#define ECRYPT_MAXIVSIZE 80    /* constant IV size 80 bit */
#define ECRYPT_IVSIZE(i) (80 + (i)*8)
