...
#define ECRYPT_MAXKEYSIZE 128            /* ABC maximum key size             */
#define ECRYPT_KEYSIZE(i) (1<<(7+i))     /* Key sizes 128, 256, 512          */

#define ECRYPT_MAXIVSIZE 128             /* ABC maximum IV size              */
#define ECRYPT_IVSIZE(i) (1<<(7+i))      /* IV sizes 32, 64, 96, 128         */
...
typedef struct
{
    ...
    u32 d0, d1;         /* B primitive coefficients                   */
