 ...
 */
#define ECRYPT_NAME "ProVEST-16"    /* [edit] */ 
#define ECRYPT_PROFILE "___H."
...
#define ECRYPT_KEYSIZE(i) (64 + (i)*8)

#define ECRYPT_MAXIVSIZE 256
#define ECRYPT_IVSIZE(i) (32 + (i)*8)

#define ECRYPT_MAXMACSIZE 512
#define ECRYPT_MACSIZE(i) (64 + (i)*8)

#else

#define ECRYPT_MAXKEYSIZE 128
#define ECRYPT_KEYSIZE(i) (128 + (i)*8)

#define ECRYPT_MAXIVSIZE 64
#define ECRYPT_IVSIZE(i) (64 + (i)*8)

#define ECRYPT_MAXMACSIZE 64
#define ECRYPT_MACSIZE(i) (64 + (i)*8)
...
typedef struct
{
  u32 k[28];	/* keyed state */
  u32 v[28];	/* current state */
  u32 macsize;	/* final MAC size in bits */
} ECRYPT_macctx;
