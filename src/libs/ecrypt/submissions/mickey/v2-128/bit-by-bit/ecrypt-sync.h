...
/* This file has been edited (in places marked [edited]) in a manner
   suitable for a bit-by-bit implementation of MICKEY-128 v1. */ 
 ...
 */
#define ECRYPT_NAME "MICKEY-128-v2"    /* [edited] */ 
...
{
    u8 R[160];
        /* The 128 bit linear register R */
    u8 S[160];
        /* The 128 bit non-linear register S */
    u8 key[16];
	...
	u32 ivsize;
		/* The IV length, which may be between 0 and 128 (but must be fixed while
