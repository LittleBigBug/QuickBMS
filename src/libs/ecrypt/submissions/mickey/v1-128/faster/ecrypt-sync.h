 ...
 */
#define ECRYPT_NAME "MICKEY-128-v1"    /* [edited] */ 
...
#define ECRYPT_MAXKEYSIZE 128                 /* [edited] */
#define ECRYPT_KEYSIZE(i) (128 + i)           /* [edited] */

#define ECRYPT_MAXIVSIZE 128                  /* [edited] */
...
{
    u32 R[4];
        /* The 128 bit linear register R is stored in 4 32 bit unsigned integers.
           The l.s.b. of R[0] is r_0, and the m.s.b. of R[3] is r_127 */
    u32 S[4];
        /* The 128 bit non-linear register S is stored in 4 32 bit unsigned integers.
           The l.s.b. of S[0] is s_0, and the m.s.b. of S[3] is s_127 */
    u8 key[16];
