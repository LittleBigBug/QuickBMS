 ...
 */
#define ECRYPT_NAME "MICKEY-v1"    /* [edited] */ 
...
{
    u32 R[3];
        /* The 80 bit linear register R is stored in 3 32 bit unsigned integers.
           The l.s.b. of R[0] is r_0, and bit 15 of R[2] is r_79 */
    u32 S[3];
        /* The 80 bit non-linear register S is stored in 3 32 bit unsigned integers.
           The l.s.b. of S[0] is s_0, and bit 15 of S[2] is s_79 */
    u8 key[10];
